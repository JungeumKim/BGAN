...
def parse_args(args, name_space):
    ...
    parser.add_argument('--worktree',
                        ...
                        #default= "/home/kim2712/Desktop/research/BGAN/BGAN/worktrees/bgan_e9866cb/BGAN",
    ...
    parser.add_argument('--repeat_id', type=int, default=0, help=' ')

    parser.add_argument('--epoch', type=int, default = 1000, help= ' ')
    parser.add_argument('--n_iter', type=int, default = 100, help= ' ') #More than 100 is not good for the LSTM networks.
