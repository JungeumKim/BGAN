...
class Generator(nn.Module):
    ...
    def __init__(self, x_dim=2,x_length=1, theta_dim = 2,  dropout = 0.1,
        ...
        self.ss = Auto_ss(f1_dim=f1_dim, f2_dim=f2_dim, 
...
class DBGAN():
    ...
    def train(self,start_epoch=1, end_epoch=None, critic_gp_factor = 5, critic_steps = 5, n_iter=100):
        ...
        for epoch in range(start_epoch, end_epoch):
            ...
            opt_Q = optim.Adam(self.Q.parameters(), lr=self.generator_lr*(lr_decay**epoch))
            ...
            for iter in range(n_iter):
                theta2, X2 = self.simulator(batch_size = self.batch_size, np_random = self.np_random)
                ...
                if n_critic < critic_steps:
                    ...
                    loss = -WD #+ self.w_regul * loss_regul*0.1
