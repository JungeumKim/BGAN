...
class DBGAN_mix(DBGAN):
    ...
    def __init__(self, simulator, theta_dim, x_dim, x_length, z_dim=None,
        ...
        self.generator.forward = self.mixed_forward_gen #self.generator_forward_closure #self.mixed_forward_gen.__get__(self.generator, Generator)
        self.critic.forward = self.mixed_forward_critic #critic_forward_closure #self.mixed_forward_critic.__get__(self.critic, Critic)

    #def critic_forward_closure(self, x, context):
    #    return self.mixed_forward_critic(x, context)

    #def generator_forward_closure(self, context, noise=None):
